      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div ref={ref} className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {projects.map((project, index) => (
            ...
            >
              <div className="h-full p-6 rounded-2xl border border-edge bg-card hover:border-emerald-400/30 transition-all duration-300 hover:shadow-lg hover:shadow-emerald-400/5 flex flex-col">
                {/* Project icon/header */}
