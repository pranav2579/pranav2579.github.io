  ...
  return (
    ...
    >
      ...
      <body className="min-h-full flex flex-col bg-surface text-heading transition-colors duration-300">
        ...
        <a
          href="#main-content"
          className="sr-only focus:not-sr-only focus:fixed focus:top-4 focus:left-4 focus:z-[100] focus:px-4 focus:py-2 focus:bg-emerald-700 focus:text-white focus:rounded-lg focus:text-sm focus:font-semibold"
        >
